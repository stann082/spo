...
public class MonitorConfig
{
    ...
    /// <summary>Which Spotify time ranges to track: "short" (4 weeks), "medium" (6 months), "long" (12 months).</summary>
    ...
    /// <summary>
    /// Name of the playlist kept equal to your top 50 tracks of the last 12 months (Spotify's long
    /// range), in rank order.
